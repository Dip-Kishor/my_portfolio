...
const Footer = () => {
  ...
  return (
    <footer className="bg-(--footer-bg) pt-20 pb-10 px-4 md:px-20 border-t border-white/5 relative overflow-hidden">
      {/* Background Glow */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-20">
        ...
        <div className="md:col-span-5">
          ...
          <p className="text-gray-400 text-sm leading-relaxed max-w-xs mb-8">
            Specializing in high-end .NET architecture and immersive React
            interfaces. Building the future of the web, one pixel at a time.
          </p>
