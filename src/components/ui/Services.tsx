const Services = () => {
    return (
        <div className="-mt-10  md:mt-20  text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-8 mx-8 md:mx-20 justify-items-center">
                <div className="bg-cards p-5 rounded-2xl text-center w-full max-w-xs">
                    ...
                    />
                    <h3 className="text-button text-2xl font-bold mb-2">Web App Development</h3>
                ...
                <div className="bg-cards p-5 rounded-2xl text-center w-full max-w-xs">
                    <img
                        ...
                        className="w-full h-30 md:h-48 object-cover rounded-lg mb-4"
                    />
                    <h3 className="text-button text-2xl font-bold mb-2">Frontend Development</h3>
                    <p className="text-sm text-muted-text">
                ...
                <div className="bg-cards p-5 rounded-2xl text-center w-full max-w-xs">
                    <img
                        ...
                        className="w-full h-30 md:h-48 object-cover rounded-lg mb-4"
                    />
                    <h3 className="text-button text-2xl font-bold mb-2">Backend Development</h3>
                    <p className="text-sm text-muted-text">
                ...
                <div className="bg-cards p-5 rounded-2xl text-center w-full max-w-xs">
                    <img
                        ...
                        className="w-full h-30 md:h-48 object-cover rounded-lg mb-4"
                    />
                    <h3 className="text-button text-2xl font-bold mb-2">E-commerce Solutions</h3>
                    <p className="text-sm text-muted-text">
                ...
                <div className="bg-cards p-5 rounded-2xl text-center w-full max-w-xs">
                    <img
                        ...
                        className="w-full h-30 md:h-48 object-cover rounded-lg mb-4"
                    />
                    <h3 className="text-button text-2xl font-bold mb-2">API Integration</h3>
                    <p className="text-sm text-muted-text">
